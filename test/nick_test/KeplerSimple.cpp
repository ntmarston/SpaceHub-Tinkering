...
int main(int argc, char** argv) {
    ...
    std::string outfile = "test/nick_test/KeplerSimple.dat";
    ...
    args.add_operation(StepSlice(DefaultWriter(outfile), 5));
...
// e.g.:
// test/nick_test/KeplerSimple -m1 1.0 -q 10 -sma 0.1 -ecc 0.1 -incl 60 -loa 0 -aop 0 -ta 0 -out "test/nick_test/KeplerSimpleCurrent.dat"