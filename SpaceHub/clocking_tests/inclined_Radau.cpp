...
int main(int argc, char** argv) {
    ...
    output_filename << "Radau" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "Radau" << "-clocktest-" << inclination_deg << ".log";
...
// g++ -std=c++17 -O3 -pthread inclined_Radau.cpp -o ct_Radau
// ./ct_Radau [inclination_in_degrees]
// Example: ./ct_Radau 5.0
