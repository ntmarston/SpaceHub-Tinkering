...
using Solver = methods::Sym10<f, particles::SizeParticles>;
/*----------------------------------------------------------------------------------------------------------------*/
...
int main(int argc, char** argv) {
    ...
    output_filename << "Sym10" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "Sym10" << "-clocktest-" << inclination_deg << ".log";
...
// g++ -std=c++17 -O3 -pthread inclined_Sym10.cpp -o ct_Sym10
// ./ct_Sym10 [inclination_in_degrees]
// Example: ./ct_Sym10 5.0
