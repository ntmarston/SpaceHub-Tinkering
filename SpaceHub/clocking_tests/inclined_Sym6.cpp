...
int main(int argc, char** argv) {
    ...
    output_filename << "Sym6" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "Sym6" << "-clocktest-" << inclination_deg << ".log";
...
// g++ -std=c++17 -O3 -pthread inclined_Sym6.cpp -o ct_Sym6
// ./ct_Sym6 [inclination_in_degrees]
// Example: ./ct_Sym6 5.0
