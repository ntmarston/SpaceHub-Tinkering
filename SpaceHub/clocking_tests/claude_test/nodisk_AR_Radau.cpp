...
// This tests whether AR_Radau agrees with other methods in the conservative (no-dissipation) case
...
int main(int argc, char** argv) {
    ...
    output_filename << "nodisk_AR_Radau" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "nodisk_AR_Radau" << "-clocktest-" << inclination_deg << ".log";
...
// Conservative (no-disk-forces) test for AR_Radau
// Compile: g++ -std=c++17 -O3 -pthread nodisk_AR_Radau.cpp -o ct_nodisk_AR_Radau
// Run: ./ct_nodisk_AR_Radau 5.0
