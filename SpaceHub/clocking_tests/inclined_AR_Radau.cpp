...
int main(int argc, char** argv) {
    ...
    output_filename << "AR_Radau" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "AR_Radau" << "-clocktest-" << inclination_deg << ".log";
...
// g++ -std=c++17 -O3 -pthread inclined_AR_Radau.cpp -o ct_AR_Radau
// ./ct_AR_Radau [inclination_in_degrees]
// Example: ./ct_AR_Radau 5.0
