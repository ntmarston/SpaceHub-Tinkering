...
int main(int argc, char** argv) {
    ...
    output_filename << "BS" << "-clocktest-" << inclination_deg << ".dat";
    log_filename << "BS" << "-clocktest-" << inclination_deg << ".log";
...
// g++ -std=c++17 -O3 -pthread inclined_BS.cpp -o ct_BS
// ./ct_BS [inclination_in_degrees]
// Example: ./ct_BS 5.0
