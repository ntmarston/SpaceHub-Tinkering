// Zhu+2019 inclination damping smoketest — circular, mildly inclined orbit at 100 Rg
// Uses DiskMigration with inclined_zhu only
// sin(0.5°) = 0.0087 < h/r ≈ 0.012 at 100 Rg
// Expected: inclination damps over ~11k year timescale
...
int main() {
    ...
    DiskMigration::inclined_zhu = true;
    ...
    print(std::cout, "Zhu test complete in ", timer.get_time(), "s\n");
    return 0;
}

// g++ -std=c++17 -O3 -pthread ZhuTest.cpp -o ZhuTest
