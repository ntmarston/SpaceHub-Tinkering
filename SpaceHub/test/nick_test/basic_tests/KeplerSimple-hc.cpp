...
int main(int argc, char** argv) {
    ...
    Particle p1{m1, 4.24e-6_Rs};
    Particle p2{m2, 4.24e-6_Rs};
    ...
    args.add_operation(TimeSlice(DefaultWriter("SpaceHub/test/nick_test/disk_model/AnalyticalTests/Circular-Dyntest.dat"), 0_year, stop_time, 500));
...
// g++ -std=c++17 -O3 -pthread test/nick_test/KeplerSimple-hc.cpp -o test/nick_test/KeplerSimple-hc
// test/nick_test/KeplerSimple-hc