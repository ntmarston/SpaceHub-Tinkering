...
int main(int argc, char** argv) {
    ...
    output_filename << "out/RuntimeDemo/incl-" << inclination_deg << "_ecc-0.0" << ".dat";
    log_filename << "out/RuntimeDemo/incl-" << inclination_deg << "_ecc-0.0" << ".log";
...
// ./runtime_demo_out/bin/runtime_demo_e0 <inclination_in_degrees>
// Example: ./runtime_demo_out/bin/runtime_demo_e0 45.0
