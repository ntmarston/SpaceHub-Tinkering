...
int main(int argc, char** argv) {
    ...
    output_filename << "ZengLowEcc-pagn/incl-" << inclination_deg << ".dat";
...
// g++ -std=c++17 -O3 -pthread ZengLowEcc-pagn.cpp -o ZengLowEcc-pagn-sim
// ./ZengLowEcc-pagn-sim <inclination_in_degrees>
// Example: ./ZengLowEcc-pagn-sim 20.0
