...
int main(int argc, char** argv) {
    ...
    DiskModel::init_from_file("../../src/interaction/disk_tab/disk_stae321_pagn.csv"); //has the discontinuity issue
...
// g++ -std=c++17 -O3 -pthread inclined_smoketest.cpp -o ismoket
// ./ismoket [inclination_in_degrees]
// Example: ./ismoket 10.0
