...
int main(int argc, char** argv) {
    ...
    */
    ...
    Solver::RunArgs args;
    auto stop_time = 1000_year;
    args.add_stop_condition(stop_time);

    auto twriter = TimeSlice(DefaultWriter("testbhldrag-mildMachRegime.csv"), 0.0, stop_time, 500);
...
// g++ -std=c++17 -O3 -pthread simulations/dragforces/testforce-bondiHoyle.cpp -o simulations/dragforces/testforce-bondiHoyle
// simulations/dragforces/testforce-bondiHoyle