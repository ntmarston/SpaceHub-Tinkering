...
int main(int argc, char** argv) {
    ...
    std::fstream ptc_res_file("simulation_results/2+1_ptcres-3demo.txt", std::ios::out);
    std::fstream ordered_inputs_file("simulation_results/ordered_inputs-3demo.txt", std::ios::out);
