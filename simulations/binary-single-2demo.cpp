...
int main(int argc, char** argv) {
    ...
    size_t n = 100; //sims per parameter will be n^2
    ...
    for(size_t i=0; i < n; ++i)
    {
        ...
        for(size_t j=0; j < n; ++j){
            ...
            Scalar t_end = 60 * time_to_periapsis(orbit::group(p1, p2), p3);
    ...
    //g++ -std=c++17 -O3 -pthread simulations/binary-single-2demo.cpp -o simulations/binary-single-2demo

    //simulations/binary-single-2demo
    return 0;
}
