...
int main(int argc, char **argv)
{
    ...
    Scalar ab = 10_AU;
    // std::fstream incident_orb_res_file("simulations/topology/binary-single-3debug/results/2+1_incident_orbres-2d.txt", std::ios::out);
    // std::fstream inner_orb_res_file("simulations/topology/binary-single-3debug/results/2+1_inner_orbres-2d.txt", std::ios::out);
    std::fstream ptc_res_file("simulations/topology/binary-single-3debug/results/3d2+1_debug.txt", std::ios::out);
    std::fstream ordered_inputs_file("simulations/topology/binary-single-3debug/results/3d2+1_ICs_debug.txt", std::ios::out);
